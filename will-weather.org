...
: getmeasure 1 date_begin=1520747706 Sat Mar 10 23:55:06 2018
: getmeasure 1 date_begin=1520747657 Sat Mar 10 23:54:17 2018
** DONE Make graphs
...
#+BEGIN_SRC python :return plotfile :results file :exports both
  ...
  ax.plot(df_inside.index.to_pydatetime(), df_inside.Noise, label="Noise")
  ax.legend()
  ax.set(
      xlabel="Date",
      ylabel="Noise, dB"
